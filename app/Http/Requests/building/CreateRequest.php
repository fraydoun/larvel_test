...
class CreateRequest extends FormRequest
{
    ...
    {
        return [
            'name.required' => 'نام ساختمان الزامی است ',
            ...
            'sheba.required' => 'شماره شبا الزامی است',
            'sheba.min' => 'شماره شبا 24 کرکتر است',
            'sheba.max' => 'شماره شبا 24 کرکتر است',
            'card_number.required' => 'شماره کارت الزامی است',
            'card_number.min' => 'شماره کارت کمتر از 16 کرکتر است',
            'card_number.max' => 'شماره کارت بیشتر از 16 کرکتر است',
            'bank_number.required' => 'شماره حساب الزامی است',
            // 'bank_number.min' => 'شماره حساب ۱۰ کرکتر است',
            // 'bank_number.max' => 'شماره حساب ۱۰ کرکتر است',
            'name_owner_bank.required' => 'نام صاحب حساب الزامی است',
            'name_owner_bank.string' => 'نام صاحب حساب باید رشته باشد',
            'last_name_owner_bank.required' => 'نام خانوادگی صاحب حساب الزامی است',
